...
final class Paramater{
	...
	public static function create(string $name, string|EnumType $enumType, ?array $enumValues = null, int $flag = self::FLAG_FORCE_COLLAPSE_ENUM, bool $optional = false) : self{
		new self($name, $enumType, $enumValues, $flag, $optional);
	}
